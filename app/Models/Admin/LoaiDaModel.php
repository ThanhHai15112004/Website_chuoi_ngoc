...
class LoaiDaModel
{
    ...
    {
        $stmt = $this->db->prepare("UPDATE loai_da SET trang_thai = CASE WHEN trang_thai = " . HeThongConstants::STATUS_ACTIVE . " THEN " . HeThongConstants::STATUS_INACTIVE . " ELSE " . HeThongConstants::STATUS_ACTIVE . " END WHERE id = ?");
        return $stmt->execute([$id]);
    }
