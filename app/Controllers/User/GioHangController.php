...
class GioHangController extends Controller {
    ...
    public function index() {
        $gio_hang = $this->gioHangService->getCart();
        ...
        if (!empty($applied_vouchers)) {
            ...
            foreach ($applied_vouchers as $id => $vc) {
                $check = $maGiamGiaModel->checkVoucherByCode($vc['ma_voucher'], $gio_hang_hop_le, $userId);
                if ($check['success']) {
    ...
    public function add() {
        ...
        $result = $this->gioHangService->addItem($id_san_pham, $id_bien_the, $so_luong);
    ...
    public function update() {
        ...
        $result = $this->gioHangService->updateItem($cart_id, $so_luong);
        echo json_encode($result);
    }
    ...
    public function remove() {
        ...
        $result = $this->gioHangService->removeItem($cart_id);
        echo json_encode($result);
    }
    ...
    public function count() {
        header('Content-Type: application/json; charset=utf-8');
        echo json_encode(['count' => $this->gioHangService->getCount()]);
    }
    ...
    public function variants() {
        ...
        $data = $this->gioHangService->getProductVariants($id_san_pham);
        if (!$data) {
    ...
    public function getVouchersForCart() {
        ...
        $maGiamGiaModel = new \App\Models\Admin\MaGiamGiaModel();
        $vouchers = $maGiamGiaModel->getEligibleVouchersForCart($gio_hang_hop_le, $userId);
    ...
    public function applyVoucher() {
        ...
        $userId = $_SESSION['user_id'] ?? $_SESSION['user']['id'] ?? null;
        $maGiamGiaModel = new \App\Models\Admin\MaGiamGiaModel();
        $result = $maGiamGiaModel->checkVoucherByCode($ma, $gio_hang_hop_le, $userId);
