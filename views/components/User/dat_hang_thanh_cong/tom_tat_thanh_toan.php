<div class="bg-stone-50 rounded-xl p-5 border border-stone-100 shadow-inner">
    ...
    <div class="space-y-3 text-sm text-gray-600">
        ...
        <div class="flex justify-between">
            ...
            <span class="font-medium text-gray-800"><?= number_format($order_info['phi_ship'], 0, ',', '.') ?>đ</span>
        </div>
        <div class="flex justify-between text-[#8B0000]">
            <span>Giảm giá</span>
            <span class="font-medium">-<?= number_format($order_info['tien_giam_gia'], 0, ',', '.') ?>đ</span>
        </div>
        <div class="pt-3 mt-3 border-t border-stone-200 flex justify-between items-center">
            ...
            <span class="font-bold text-2xl text-[#8B0000]"><?= number_format($order_info['thanh_tien'], 0, ',', '.') ?>đ</span>
        </div>
    </div>
</div>
