...
<div class="mt-16">
    <div class="flex justify-between items-end mb-8 border-b border-gray-100 pb-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Những lựa chọn tuyệt vời khác cùng danh mục</p>
        </div>
        <div class="flex items-center gap-4">
            <!-- Navigation buttons for Swiper -->
            <div class="hidden md:flex gap-2">
                <button class="related-swiper-prev w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 hover:border-crimson-600 hover:bg-crimson-50 hover:text-crimson-600 transition-all">
                    <iconify-icon icon="heroicons:arrow-left" class="text-lg"></iconify-icon>
                </button>
                <button class="related-swiper-next w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 hover:border-crimson-600 hover:bg-crimson-50 hover:text-crimson-600 transition-all">
                    <iconify-icon icon="heroicons:arrow-right" class="text-lg"></iconify-icon>
                </button>
            </div>
            <a href="<?= APP_URL ?>/san-pham" class="text-crimson-600 hover:text-crimson-700 font-semibold text-sm flex items-center group">
                Xem tất cả 
                <iconify-icon icon="heroicons:arrow-long-right" class="ml-2 text-lg transform group-hover:translate-x-1 transition-transform"></iconify-icon>
            </a>
        </div>
    </div>

    <!-- Swiper Container -->
    <div class="swiper related-products-swiper -mx-4 px-4 sm:mx-0 sm:px-0 py-4">
            ...
            <?php foreach ($san_pham_lien_quan as $sp): ?>
                ...
                <div class="swiper-slide h-auto">
                    <div class="product-card group h-full bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:shadow-crimson-100/50 hover:-translate-y-1 transition-all duration-300 flex flex-col">
                        ...
                        <!-- Ảnh sản phẩm (Đã chỉnh lại aspect-square thay vì 4/5) -->
