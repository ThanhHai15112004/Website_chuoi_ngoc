<?php if (!empty($featured_articles)): ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8 group">
            <a href="<?= APP_URL ?>/chi-tiet-bai-viet?slug=<?= htmlspecialchars($main_article['slug']) ?>" class="block overflow-hidden rounded-xl relative shadow-md h-[400px] lg:h-[500px]">
        ...
        <div class="lg:col-span-4 flex flex-col gap-6">
            ...
            <a href="<?= APP_URL ?>/chi-tiet-bai-viet?slug=<?= htmlspecialchars($article['slug']) ?>" class="block group flex-1 bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md border border-gray-100 transition-all flex flex-col">
