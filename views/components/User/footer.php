            ...
            <div data-aos="fade-up" data-aos-delay="300">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-start">
                        ...
                        <span class="text-sm pt-1" style="color: #999;">Hotline: <a href="tel:<?= htmlspecialchars($fc['hotline_chinh']) ?>" style="color: #d4af37;" class="font-semibold hover:underline"><?= format_phone_number($fc['hotline_chinh']) ?></a></span>
                    </li>
                    ...
                    <li class="flex items-start">
                        ...
                        <span class="text-sm pt-1" style="color: #999;">Email: <a href="mailto:<?= htmlspecialchars($fc['email']) ?>" style="color: #d4af37;" class="hover:underline"><?= htmlspecialchars($fc['email']) ?></a></span>
                    </li>
                    <?php endif; ?>
