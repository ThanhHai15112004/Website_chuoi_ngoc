...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <article class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg border border-gray-100 transition-all duration-300 group flex flex-col">
        <!-- Thumbnail -->
        <a href="<?= APP_URL ?>/chi-tiet-bai-viet?id=<?= $article['id'] ?>" class="block h-48 overflow-hidden relative">
        ...
        <div class="p-5 flex-1 flex flex-col">
            ...
            <a href="<?= APP_URL ?>/chi-tiet-bai-viet?id=<?= $article['id'] ?>" class="block mb-2 flex-1">
            ...
            <div class="mt-auto pt-4 border-t border-gray-100">
                <a href="<?= APP_URL ?>/chi-tiet-bai-viet?id=<?= $article['id'] ?>" class="inline-flex items-center gap-1 text-red-800 font-medium text-sm hover:text-red-600 transition-colors group/link">
                    Đọc tiếp 
