    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col">
        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
            <h3 class="text-lg font-bold text-gray-900 flex items-center gap-2">
                <span class="iconify text-[#6B0D18]" data-icon="mdi:export-variant"></span> Xuất báo cáo sản phẩm
            </h3>
        ...
        <div class="px-6 py-5 flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div class="space-y-5">
                ...
                <!-- Tùy chọn dữ liệu -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Dữ liệu muốn xuất</label>
                    <div class="space-y-2 border border-gray-100 rounded-xl p-3 bg-white">
                        <label class="flex items-center gap-3 p-2 rounded hover:bg-gray-50 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">Tổng quan & Biểu đồ</span>
                        </label>
                        <label class="flex items-center gap-3 p-2 rounded hover:bg-gray-50 cursor-pointer">
                            <input type="checkbox" checked class="w-4 h-4 text-[#6B0D18] rounded border-gray-300 focus:ring-[#6B0D18]">
                            <span class="text-sm text-gray-700">Top bán chạy & Bán chậm</span>
                        </label>
                        <label class="flex items-center gap-3 p-2 rounded hover:bg-gray-50 cursor-pointer">
                            <input type="checkbox" checked class="w-4 h-4 text-[#6B0D18] rounded border-gray-300 focus:ring-[#6B0D18]">
                            <span class="text-sm text-gray-700">Cảnh báo tồn kho</span>
                        </label>
                        <label class="flex items-center gap-3 p-2 rounded hover:bg-gray-50 cursor-pointer">
                            <input type="checkbox" checked class="w-4 h-4 text-[#6B0D18] rounded border-gray-300 focus:ring-[#6B0D18]">
                            <span class="text-sm text-gray-700">Toàn bộ chi tiết 120 sản phẩm</span>
                        </label>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function startExport() {
        ...
        setTimeout(() => {
            ...
            alert("Báo cáo sản phẩm đã sẵn sàng và đang được tải xuống!");
        }, 2000);
    }
</script>
