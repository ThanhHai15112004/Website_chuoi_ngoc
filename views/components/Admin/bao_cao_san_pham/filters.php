<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
    ...
    <div class="flex flex-wrap items-center gap-3">
        <select class="px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-700 focus:border-[#6B0D18] focus:ring-0 outline-none w-full md:w-auto min-w-[150px]">
            <option>Tất cả danh mục</option>
            <option>Vòng tay phong thủy</option>
            <option>Chuỗi ngọc</option>
            <option>Vòng đá tự nhiên</option>
            <option>Quà tặng phong thủy</option>
        </select>
        ...
        <select class="px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-700 focus:border-[#6B0D18] focus:ring-0 outline-none w-full md:w-auto">
            ...
            <option>Mã não</option>
            <option>Trầm hương</option>
        </select>

        <select class="px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-700 focus:border-[#6B0D18] focus:ring-0 outline-none w-full md:w-auto">
            <option>Mệnh phong thủy</option>
            <option>Kim</option>
            <option>Mộc</option>
            <option>Thủy</option>
            <option>Hỏa</option>
        ...
        <select class="px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-700 focus:border-[#6B0D18] focus:ring-0 outline-none w-full md:w-auto">
            <option>Hiệu quả bán</option>
            <option>Bán chạy</option>
            <option>Bán ổn định</option>
            <option selected>Bán chậm</option>
            <option>Tồn kho cao</option>
        </select>
        
        <select class="px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-700 focus:border-[#6B0D18] focus:ring-0 outline-none w-full md:w-auto">
            <option>Khuyến mãi</option>
            <option>Đang khuyến mãi</option>
            <option>Không khuyến mãi</option>
        </select>
    ...
    <div class="flex items-center gap-2 mt-4 pt-4 border-t border-gray-50">
        ...
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-red-50 text-red-800 text-xs font-medium border border-red-100">
            Bán chậm <span class="iconify cursor-pointer hover:text-red-900" data-icon="mdi:close"></span>
        </span>
    </div>
