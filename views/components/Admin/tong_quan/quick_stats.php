<?php
// views/components/admin/tong-quan/quick_stats.php
?>
<!-- Quick Stats Grid -->
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div class="flex justify-between items-start relative z-10">
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800 font-luxury"><?= format_currency_short($thong_ke_nhanh['doanh_thu_hom_nay']) ?></h3>
            </div>
