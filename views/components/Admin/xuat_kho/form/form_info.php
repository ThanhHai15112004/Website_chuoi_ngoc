    ...
    <div class="p-5">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
                ...
                <input type="text" value="XK202600124" class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-[#6B0D18] focus:border-[#6B0D18] sm:text-sm font-bold text-[#6B0D18] bg-gray-50 cursor-not-allowed" readonly>
            ...
            <div>
                ...
                <select id="loaiXuatSelect" onchange="toggleLienKetForm()" class="block w-full pl-3 pr-10 py-2 text-sm border-gray-300 focus:outline-none focus:ring-[#6B0D18] focus:border-[#6B0D18] rounded-lg shadow-sm">
            ...
            <!-- Ngày dự kiến xuất -->
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Ngày dự kiến xuất <span class="text-red-500">*</span></label>
                <input type="datetime-local" class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-[#6B0D18] focus:border-[#6B0D18] sm:text-sm text-gray-700">
            </div>
            ...
            <div>
                ...
                <select class="block w-full pl-3 pr-10 py-2 text-sm border-gray-300 focus:outline-none focus:ring-[#6B0D18] focus:border-[#6B0D18] rounded-lg shadow-sm bg-gray-50">
