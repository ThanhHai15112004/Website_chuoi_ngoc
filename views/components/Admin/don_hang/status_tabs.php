    ...
    <div class="flex items-center gap-2 overflow-x-auto pb-2 hide-scrollbar border-b border-gray-200" id="statusTabs">
        ...
        <button onclick="switchTab(this, 'Đang chuẩn bị')" class="tab-btn px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap flex items-center gap-2 transition-colors border-b-2 border-transparent hover:border-gray-300">
            Đang chuẩn bị <span class="bg-blue-50 text-blue-600 px-1.5 py-0.5 rounded text-[10px] font-mono font-bold" id="tabDangChuanBi"><?= $stats['dang_chuan_bi'] ?></span>
        </button>
        <button onclick="switchTab(this, 'Đang giao')" class="tab-btn px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap flex items-center gap-2 transition-colors border-b-2 border-transparent hover:border-gray-300">
            Đang giao <span class="bg-teal-50 text-teal-600 px-1.5 py-0.5 rounded text-[10px] font-mono font-bold" id="tabDangGiao"><?= $stats['dang_giao'] ?></span>
        </button>
        ...
        <button onclick="switchTab(this, 'Đã hủy')" class="tab-btn px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap flex items-center gap-2 transition-colors border-b-2 border-transparent hover:border-gray-300">
            Đã hủy <span class="bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded text-[10px] font-mono font-bold" id="tabDaHuy"><?= $stats['da_huy'] ?></span>
        </button>
    </div>
