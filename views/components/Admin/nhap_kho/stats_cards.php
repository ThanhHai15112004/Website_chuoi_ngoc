...
<div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-6">
    ...
    <div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm flex flex-col justify-between">
        ...
        <div>
            <h3 class="text-2xl font-bold text-gray-900"><?= number_format($stats['tat_ca'] ?? 0, 0, ',', '.') ?></h3>
            <p class="text-xs text-gray-500 mt-1">phiếu</p>
        </div>
    </div>

    <!-- Chờ kiểm hàng -->
    <div class="bg-white rounded-xl p-4 border border-yellow-200 shadow-sm flex flex-col justify-between relative overflow-hidden cursor-pointer" onclick="filterByStatus('1')">
        ...
        <div>
            <h3 class="text-2xl font-bold text-yellow-600"><?= number_format($stats['cho_kiem'] ?? 0, 0, ',', '.') ?></h3>
            <p class="text-xs text-gray-500 mt-1">phiếu</p>
        </div>
    </div>

    <!-- Đang kiểm hàng -->
    <div class="bg-white rounded-xl p-4 border border-blue-200 shadow-sm flex flex-col justify-between relative overflow-hidden cursor-pointer" onclick="filterByStatus('2')">
        ...
        <div>
            <h3 class="text-2xl font-bold text-blue-600"><?= number_format($stats['dang_kiem'] ?? 0, 0, ',', '.') ?></h3>
            <p class="text-xs text-gray-500 mt-1">phiếu</p>
        </div>
    </div>

    <!-- Đã nhập kho -->
    <div class="bg-white rounded-xl p-4 border border-emerald-200 shadow-sm flex flex-col justify-between relative overflow-hidden cursor-pointer" onclick="filterByStatus('3')">
        ...
        <div>
            <h3 class="text-2xl font-bold text-emerald-600"><?= number_format($stats['da_nhap'] ?? 0, 0, ',', '.') ?></h3>
            <p class="text-xs text-gray-500 mt-1">phiếu</p>
        </div>
    </div>

    <!-- Có lỗi / thiếu hàng -->
    <div class="bg-white rounded-xl p-4 border border-rose-200 shadow-sm flex flex-col justify-between relative overflow-hidden cursor-pointer">
        ...
        <div>
            <h3 class="text-2xl font-bold text-rose-600"><?= number_format($stats['loi_thieu'] ?? 0, 0, ',', '.') ?></h3>
            <p class="text-xs text-gray-500 mt-1">phiếu</p>
        </div>
    </div>
