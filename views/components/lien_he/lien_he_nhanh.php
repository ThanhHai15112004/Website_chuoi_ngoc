<!-- views/components/lien_he/lien_he_nhanh.php -->
<section class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
    <h2 class="text-xl font-serif text-gray-900 mb-6 font-bold">Kênh liên hệ nhanh</h2>
    
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        
        <!-- Hotline -->
        <a href="tel:0901234567" class="group block p-6 rounded-2xl border border-red-100 bg-red-50/50 hover:bg-white hover:border-red-200 hover:shadow-md transition-all duration-300">
            ...
            <p class="text-xl font-medium text-red-800 mb-2">090.123.4567</p>
        ...
        <!-- Zalo -->
        <a href="https://zalo.me/0901234567" target="_blank" class="group block p-6 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all duration-300 bg-white">
        ...
        <!-- Facebook -->
        <a href="https://m.me/chuoingocphongthuy" target="_blank" class="group block p-6 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all duration-300 bg-white">
            <div class="w-12 h-12 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Email -->
        <a href="mailto:support@chuoingocphongthuy.vn" class="group block p-6 rounded-2xl border border-gray-100 hover:border-red-200 hover:shadow-md transition-all duration-300 bg-white">
            ...
            <p class="text-base text-gray-900 mb-2 truncate" title="support@chuoingoc.vn">support@chuoingoc.vn</p>
