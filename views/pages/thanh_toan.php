...
<div class="bg-slate-50 py-8 pb-32 md:py-12 md:pb-16">
    <div class="container mx-auto px-4 max-w-6xl">
        <!-- Breadcrumb -->
        <?php require_once __DIR__ . '/../components/thanh_toan/breadcrumb.php'; ?>

        <?php if(empty($gio_hang)): ?>
            <!-- Trạng thái giỏ hàng trống khi thanh toán -->
            <?php require_once __DIR__ . '/../components/thanh_toan/gio_hang_trong.php'; ?>
        <?php else: ?>
            <div class="flex flex-col lg:flex-row gap-8">
                <!-- Cột trái: Form thông tin thanh toán -->
                <div class="lg:w-2/3 space-y-6">
                    <!-- Thông tin người nhận -->
                    <?php require_once __DIR__ . '/../components/thanh_toan/thong_tin_nguoi_nhan.php'; ?>

                    <!-- Địa chỉ giao hàng -->
                    <?php require_once __DIR__ . '/../components/thanh_toan/dia_chi_giao_hang.php'; ?>

                    <!-- Phương thức thanh toán -->
                    <?php require_once __DIR__ . '/../components/thanh_toan/phuong_thuc_thanh_toan.php'; ?>
                </div>

                <!-- Cột phải: Tóm tắt đơn hàng -->
                <div class="lg:w-1/3">
                    <?php require_once __DIR__ . '/../components/thanh_toan/tom_tat_don_hang.php'; ?>
                </div>
            </div>

            <!-- Sticky Checkout Button cho Mobile -->
            <?php require_once __DIR__ . '/../components/thanh_toan/sticky_mobile_btn.php'; ?>
