<?php
// views/pages/admin_tong_quan.php
?>
<div class="space-y-6">
    <!-- Page Header -->
    ...
    <?php require_once __DIR__ . '/../components/Admin/tong_quan/quick_stats.php'; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            <?php require_once __DIR__ . '/../components/Admin/tong_quan/revenue_chart.php'; ?>

            <?php require_once __DIR__ . '/../components/Admin/tong_quan/recent_orders.php'; ?>
        </div>

        <!-- Right Column: Activities, Alerts, Products -->
        <div class="space-y-6">
            
            <?php require_once __DIR__ . '/../components/Admin/tong_quan/best_selling_products.php'; ?>

            <?php require_once __DIR__ . '/../components/Admin/tong_quan/system_alerts.php'; ?>

            <?php require_once __DIR__ . '/../components/Admin/tong_quan/recent_activity.php'; ?>
