...
<div class="px-6 py-6 pb-20 max-w-[1600px] mx-auto min-h-screen bg-gray-50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500 mb-1">Xuất kho thành công (Tháng này)</p>
                <div class="flex items-baseline gap-2">
                    <h3 class="text-2xl font-bold text-gray-900">42</h3>
                    <span class="text-xs text-emerald-600 font-medium bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100">+5% so với tháng trước</span>
                </div>
            </div>
        </div>
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500 mb-1">Đang chờ duyệt / Đang xuất</p>
                <div class="flex items-baseline gap-2">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
            <div class="w-14 h-14 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center shrink-0">
                <span class="iconify text-3xl" data-icon="mdi:package-variant-closed"></span>
            </div>
            <div>
                <p class="text-sm font-medium text-gray-500 mb-1">Tổng SP xuất (Tháng này)</p>
                <h3 class="text-xl font-bold text-[#6B0D18]">158 <span class="text-sm font-normal text-gray-500">sp</span></h3>
            </div>
        </div>
    </div>
