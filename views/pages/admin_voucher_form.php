...
<div class="space-y-6 animate-[fadeInPage_0.3s_ease-out]">
    ...
    <?php include __DIR__ . '/../components/Admin/voucher/form_area.php'; ?>
    <?php include __DIR__ . '/../components/Admin/voucher/form_preview_area.php'; ?>
    <?php include __DIR__ . '/../components/Admin/voucher/form_modals.php'; ?>
    <?php include __DIR__ . '/../components/Admin/voucher/form_scripts.php'; ?>
