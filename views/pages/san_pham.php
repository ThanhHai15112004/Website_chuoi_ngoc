...
<?php include __DIR__ . '/../components/san_pham/banner.php'; ?>

<!-- Breadcrumb -->
<?php include __DIR__ . '/../components/san_pham/breadcrumb.php'; ?>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside id="filter-sidebar" class="w-full lg:w-[280px] lg:flex-shrink-0">
            <?php include __DIR__ . '/../components/san_pham/bo_loc.php'; ?>
        </aside>

        <!-- Vùng hiển thị sản phẩm (75%) -->
        <main class="flex-1 min-w-0">
            <!-- Thanh sắp xếp + view mode -->
            <?php include __DIR__ . '/../components/san_pham/thanh_sap_xep.php'; ?>
            
            <!-- Danh sách sản phẩm dạng Grid -->
            <?php include __DIR__ . '/../components/san_pham/danh_sach.php'; ?>
            
            <!-- Phân trang -->
            <?php include __DIR__ . '/../components/san_pham/phan_trang.php'; ?>
        </main>
