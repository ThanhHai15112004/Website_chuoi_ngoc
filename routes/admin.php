...
$router->post('/admin/loai-da/luu', 'Admin\LoaiDaController@store');
$router->post('/admin/loai-da/xoa/([a-zA-Z0-9_-]+)', 'Admin\LoaiDaController@delete');
$router->post('/admin/loai-da/an-hien/([a-zA-Z0-9_-]+)', 'Admin\LoaiDaController@toggleStatus');
$router->get('/admin/loai-da/them', 'Admin\LoaiDaController@create');
$router->get('/admin/loai-da/sua/([a-zA-Z0-9_-]+)', 'Admin\LoaiDaController@edit');
...
$router->post('/admin/menh-phong-thuy/an-hien/([a-zA-Z0-9_-]+)', 'Admin\MenhPhongThuyController@toggleStatus');
